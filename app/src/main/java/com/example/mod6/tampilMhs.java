...
public class tampilMhs extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextJur = (EditText) findViewById(R.id.editTextJurus);
    ...
    private void showEmployee(String json){
        try {
            ...
            editTextJur.setText(desg);
            editTextMail.setText(sal);
    ...
    private void updateEmployee(){
        ...
        final String desg = editTextJur.getText().toString().trim();
        final String salary = editTextMail.getText().toString().trim();
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(konfigurasi.KEY_EMP_JURUSAN,desg);
                hashMap.put(konfigurasi.KEY_EMP_EMAIL,salary);
